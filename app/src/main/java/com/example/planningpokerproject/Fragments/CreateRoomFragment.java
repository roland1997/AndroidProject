    ...
    private void activate(){
        ...
        adapter.setOnClickListener(new MyAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                myRef.child(listing.get(position).getQuestionID()).child("Active Room").setValue(listing.get(position).getQuestion());
                mRef.child("Groups").child(listing.get(position).getQuestionID()).child("Active Room").setValue(listing.get(position).getQuestion());
    ...
    private void setDate() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(getActivity(), new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker datePicker, int year, int month, int date) {
                ...
                dateTimeText = DateFormat.format("dd/MM/yyyy", calendar1).toString();
